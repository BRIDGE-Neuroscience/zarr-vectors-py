...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("ObjectIndexPendingMeta",
         {"zv_array": "object_index_pending", "batch_id": 0,
          "num_objects": 7, "sid_ndim": 3}),
        ("ObjectAttributeMeta",
        ...
        ("CrossChunkFacesMeta",
         {"zv_array": "cross_chunk_faces", "num_faces": 4,
          "sid_ndim": 3, "record_size": 5}),
        ("LinkAttributeMeta",
         {"zv_array": "link_attribute", "name": "weight", "dtype": "float32"}),
        ("MetanodeChildrenMeta",
         {"zv_array": "metanode_children", "num_metanodes": 3, "sid_ndim": 3}),
    ],
)
